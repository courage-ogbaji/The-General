...
export type WishFormState = { error: string } | undefined;
...
export function WishForm({
  ...
  const [state, formAction, isPending] = useActionState<
    ...
    FormData
  >(action, undefined);
  const [media, setMedia] = useState<WishMedia[]>(initialMedia);
  const uploadPreset = process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET;

  return (
    <div className="mx-auto max-w-xl px-4 py-24 sm:py-28">
